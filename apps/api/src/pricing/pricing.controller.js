...
var PricingController = function () {
    var _classDecorators = [(0, common_1.Controller)('pricing')];
    ...
    var PricingController = _classThis = /** @class */ (function () {
        ...
        PricingController_1.prototype.calculate = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var errors;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            errors = this.pricingService.validateInput(input);
                            if (errors.length > 0) {
                            ...
                            return [4 /*yield*/, this.pricingService.calculatePrice(input)];
                        case 1: 
                        // Calculate price
    ...
    (function () {
        ...
        _calculate_decorators = [(0, common_1.Post)('calculate')];
