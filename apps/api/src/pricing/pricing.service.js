...
var PricingService = function () {
    ...
    var PricingService = _classThis = /** @class */ (function () {
         ...
         */
        PricingService_1.prototype.calculatePrice = function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var materialCost, laborCost, subtotal, discount, total, breakdown;
                return __generator(this, function (_a) {
                    materialCost = this.calculateMaterialCost(input);
                    laborCost = this.calculateLaborCost(input.laborCosts);
         ...
         */
        PricingService_1.prototype.calculateMaterialCost = function (input) {
            // TODO: ดึงราคาวัสดุจาก Database
            // ตอนนี้ hard-code ไว้ก่อน
            var MOCK_MATERIAL_PRICES = {
                flex: 150, // 150 บาท/ตร.ม.
                inkjet: 200, // 200 บาท/ตร.ม.
                acrylic: 500, // 500 บาท/ตร.ม.
                sticker: 100, // 100 บาท/ตร.ม.
            };
            var pricePerUnit = MOCK_MATERIAL_PRICES[input.materialId.toLowerCase()] || 150;
            // ถ้ามีขนาด = คำนวณจากพื้นที่
            if (input.width && input.height) {
                var area = input.width * input.height; // ตร.ม.
         ...
         * คำนวณค่าแรงรวม
         */
        PricingService_1.prototype.calculateLaborCost = function (laborCosts) {
            return laborCosts.reduce(function (total, labor) {
         ...
         */
        PricingService_1.prototype.validateInput = function (input) {
            var errors = [];
            if (!input.materialId) {
